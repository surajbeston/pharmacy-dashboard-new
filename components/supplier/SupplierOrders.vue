<template>
    <div class="mt-10">
        ...
        <div
            ...
            <div v-for="order in supplierOrders" :key="order.id" class="flex flex-col h-full gap-5 max-w-xl shadow-lg rounded-sm border border-gray-200">
                <div class="grow p-5">
                    <header>
...
watch(() => props.supplier, async (newSupplier) => {
    var response = await useBaseFetch(`/admin-api/meds/supplierorder/?supplier=${newSupplier.id}&limit=100000`)
