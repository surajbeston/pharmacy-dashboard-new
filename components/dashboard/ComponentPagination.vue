<template>
    <div class="px-6 py-8 width-full">
        <div class="flex justify-between">
            <div v-if="previousPage" class="ml-3 first:ml-0">
                <a class="btn btn-border bg-white border-gray-200 text-indigo-500 cursor-pointer"
            ...
            <div v-if="nextPage" class="ml-3 first:ml-0">
                <a class="btn bg-white btn-border border-gray-200 text-indigo-500 cursor-pointer" @click="gotoNextPage()">Next</a>
            </div>
        </div>
    </div>
</template>
