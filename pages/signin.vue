                ...
                <div class="min-h-screen h-full flex flex-col after:flex-1">
                    ...
                    <div class="max-w-sm mx-auto px-4 py-8">
                        ...
                        <div>
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input v-model="phoneNumber" id="phoneNumber" class="form-input w-full" type="text" />
                                </div>
                                <div>
                            ...
                            <div class="flex items-center justify-between mt-6">
                                ...
                                <a id="signInSubmitButton" @click="signin()"
                                    class="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-3 cursor-pointer">Sign
                                    In</a>
                            </div>
                        </div>
                        <!-- Footer -->
                        <div class="pt-5 mt-6 border-t border-gray-200">
                            <div class="text-sm">
                                Don’t you have an account? <a class="font-medium text-indigo-500 hover:text-indigo-600"
                                    href="signup.html">Sign Up</a>
                            </div>
                            <!-- Warning -->
                            <div id="loginErrors" class="mt-5">
                                <div class="bg-yellow-100 text-yellow-600 px-3 py-2 rounded hidden">
